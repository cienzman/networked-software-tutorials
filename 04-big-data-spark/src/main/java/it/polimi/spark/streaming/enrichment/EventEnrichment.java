...
/**
 * 
 * Apache Spark Structured Streaming: the stream processing logic look exactly like static batch processing logic. We are using a single
 *  programming model to deal with both dynamic dataset and static dataset. 
 * 
...
public class EventEnrichment {
    public static void main(String[] args) throws Exception {
        ...
        Dataset<Row> inStreamDF = inStream.toDF("product"); // rename the default "value" column to "product" for the sake of join operation.
