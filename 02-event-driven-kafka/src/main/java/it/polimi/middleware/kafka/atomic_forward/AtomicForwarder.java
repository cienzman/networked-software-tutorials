...
public class AtomicForwarder {
    ...
    public static void main(String[] args) {
        ...
        consumerProps.put(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG, String.valueOf(false)); // we want to commit this offset as part of the transaction that write to topic B
        ...
        while (true) {
            ...
            for (final ConsumerRecord<String, String> record : records) {
                ...
                producer.send(new ProducerRecord<>(outputTopic, record.key(), record.value())); // Write in the output topic
            }
