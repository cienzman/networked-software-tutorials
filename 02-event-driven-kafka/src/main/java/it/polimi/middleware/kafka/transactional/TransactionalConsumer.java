...
public class TransactionalConsumer {
    ...
    public static void main(String[] args) {
        ...
        /*
         * Isolation Level:
         * 		- readUncommitted: read all messages that have been pushed to kafka even if they are not commited yet.
         * 		- readCommitted: read only messages that have been commited as part of a transaction.
         */	
        if (readUncommitted) {
