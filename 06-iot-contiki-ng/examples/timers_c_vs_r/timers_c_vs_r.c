...
/* use the following instruction in the rtimer_callback() function to delete the drift problem
    - rtimer_set(&print_rtimer, t->time + RTIMER_HARD_INTERVAL, 0, rtimer_callback, "Hello world RT\n");
*/

/* Look at timer_c_vs_r_alternative.c for an deep explanation of the timers*/